...
<!-- Mirrored from www.themelooks.net/demo/kinen/html/preview/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 29 Aug 2024 15:45:24 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
        ...
        <div class="slider-inner-wrap">
            <div class="owl-carousel banner-carousel1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="single-slider-text">
                                    <span><a href="shop-details.html">#Review</a></span>
                                    <h1>Feedback Drives Change.</h1>
                                    <p>Every review you share helps others discover top-quality products, avoid pitfalls, and make informed choices. Whether it's a rating or a detailed review, your voice has the power to influence buying decisions, guide improvements, and build a community of trust. Be a part of the change – share your insights and help others shop smarter.</p>
                ...
                <!-- single slider wrap -->
                 ...
                 <!-- single slider wrap -->
                <div class="single-slider-wrap" data-bg-img='assets/img/banner/bannar1-img3.png'>
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="banner-image" data-trigger="parallax_layers">
                                    <img src="assets/img/banner/lamp.png" alt="" data-depth="0.5">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <!-- slider text -->
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="single-colection-inner overlay2 type2">
                            ...
                            <img src="assets/img/add/collection-1.jpg" alt=""> 
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="single-colection-inner overlay3 type2">
                            <div class="single-colection-img">
                            <img src="assets/img/add/collection-2.jpg" alt=""> 
                            </div>
                            <div class="single-colection">
                                <h3>Top Sellers</h3>
                                <a href="#" class="btn">Shop Now</a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="single-colection-inner overlay4 type2">
                            <div class="single-colection-img">
                            <img src="assets/img/add/collection-3.jpg" alt=""> 
                            </div>
                            <div class="single-colection">
                                <h3>Hot Deals</h3>
                                <a href="#" class="btn">Shop Now</a>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="featured-content content-left">
                                    <p>#Home Decor</p>
                                    <h3><a href="#">Woven Throw Pillow </a></h3>
                                    <h4>$25.0</h4> <span>$32</span>
                            ...
                            <div class="col-md-12">
                                <a href="#">
                                    ...
                                    <div class="featured-item-image feature-long">
                                        <img class='normal-state' data-rjs="2" src="assets/img/featuerd/featured2.jpg" alt="">
                                        <img class='hover-state' data-rjs="2" src="assets/img/featuerd/featured2-b.jpg" alt="">
                                    </div>
                                ...
                                <div class="featured-content content-right">
                                    <p>#Women's Shoes</p>
                                    <h3><a href="#">Stiletto Heeled Pump Sandals</a></h3>
                                    <h4>$82.9</h4> <span>$102</span>
                                    <div class="add-to-btn">
                                        <a href="#" class="add-to-bag">
                                            <img src="assets/img/icons/add-bag.svg" alt="" class="svg">
                                        </a>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <a href="#">
                                    <!-- feature item image -->
                                    <div class="featured-item-image feature-long">
                                        <img class='normal-state' data-rjs="2" src="assets/img/featuerd/featured3.jpg" alt="">
                                        <img class='hover-state' data-rjs="2" src="assets/img/featuerd/featured3-b.jpg" alt="">
                                    </div>
                                    <!-- End of feature item image -->
                                </a>
                                 <!-- feature content -->
                                <div class="featured-content content-right">
                                    <p>#Women's Shoes</p>
                                    <h3><a href="#">Women's Metal Aviator Sunglasses</a></h3>
                                    <h4>$48.6</h4> <span>$60.3</span>
                                    <div class="add-to-btn">
                                        <a href="#" class="add-to-bag">
                                            <img src="assets/img/icons/add-bag.svg" alt="" class="svg">
                                        </a>
                        ...
                        <div class="row align-items-center text-rev">
                            <div class="col-sm-6">
                                <a href="#">
                                    <!-- feature image long -->
                                    <div class="featured-item-image feature-small">
                                        <img class='normal-state' data-rjs="2" src="assets/img/featuerd/featured4.jpg" alt="">
                                        <img class='hover-state' data-rjs="2" src="assets/img/featuerd/featured4-b.jpg" alt="">
                                        <!-- End of feature image long -->
                                    </div>
                                </a>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <div class="featured-content content-left">
                                    <p>#Home Decor</p>
                                    <h3><a href="#">Tanglewood Outdoor Table Lamp</a></h3>
                                    <h4>$143</h4> <span>$160</span>
                                    <div class="add-to-btn">
                                        <a href="#" class="add-to-bag">
                                            <img src="assets/img/icons/add-bag.svg" alt="" class="svg">
                                        </a>
    ...
    <!-- offer -->
    <section>
        <div class="offer parallax-window" data-parallax="scroll" data-image-src="assets/img/featuerd/offer.jpg">
            <div class="container">
...
<!-- Mirrored from www.themelooks.net/demo/kinen/html/preview/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 29 Aug 2024 15:45:29 GMT -->
</html>