...
<!-- Mirrored from www.themelooks.net/demo/kinen/html/preview/shop-4col-withbar.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 29 Aug 2024 15:45:44 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
   ...
   <?php include './loader.php';?>
    ...
    <!-- filter menu -->
    <div class="offcanvas offcanvas-filter">
        <div class="offcanvas-cancel">
            <img src="assets/img/icons/close-button.svg" class="svg" alt="">
        </div>
    </div>
                                ...
                                <div class="col-md-6 position-static">
                                    ...
                                    <div class="product-filter-inner">
                                        ...
                                        <div class="product-grid-view">
                                            <!-- <ul class="nav">
                                                <li><a class="active" id="nav-four-col" data-toggle="tab" href="#fourcol"><img src="assets/img/icons/3grid.svg" class="svg" alt=""></a></li>
                                                <li><a class="" id="nav-three-col" data-toggle="tab" href="#threecol"><img src="assets/img/icons/3grid.svg" class="svg" alt=""></a></li>
                                                <li><a  class="" id="nav-two-tab" data-toggle="tab" href="#twocol"><img src="assets/img/icons/2grid.svg" class="svg" alt=""></a></li>
                                                <li><a class="" id="nav-one-tab" data-toggle="tab" href="#onecol"><img src="assets/img/icons/1grid.svg" class="svg" alt=""></a></li>
                                            </ul> -->
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="tab-content shop-tab-content">
                                            ...
                                            <div class="single-product">
                                                <div class="product-item">
                                                    ...
                                                    <div class="product-info">
                                                        <div class="product-price"><h5>$30.1</h5></div>
                                        ...
                                        <div class="col-md-6 col-sm-12 col-lg-4 col-xl-3">
                                            ...
                                            <div class="single-product">
                                                <div class="product-item">
                                                    ...
                                                    <!-- product info -->
                                                    <div class="product-info">
                                                        <div class="product-price"><h5>$24.1</h5></div>
                                                        <div class="product-rating">
                                                            <div class="star-rating">
                                                                <span></span>
                                                            </div>
                                        ...
                                        <div class="col-md-6 col-sm-12 col-lg-4 col-xl-3">
                                            ...
                                            <div class="single-product">
                                                <div class="product-item">
                                                    ...
                                                    <!-- product info -->
                                                    <div class="product-info">
                                                        <div class="product-price"><h5>$32</h5></div>
                                                        <div class="product-rating">
                                                            <div class="star-rating">
                                                                <span></span>
                                                            </div>
                                        ...
                                        <div class="col-md-6 col-sm-12 col-lg-4 col-xl-3">
                                            ...
                                            <div class="single-product">
                                                <div class="product-item">
                                                    ...
                                                    <!-- product info -->
                                                    <div class="product-info">
                                                        <div class="product-price"><h5>$10</h5></div>
                                                        <div class="product-rating">
                                                            <div class="star-rating">
                                                                <span></span>
                                                            </div>
                                            ...
                                            <div class="single-product  new-product-tag">
                                                <div class="product-item">
                                                    <div class="product-thumb">
                                                        ...
                                                        <!-- product title -->
                                                        <div class="product-title">
                                                            <h4><a href="shop-details.html">Cat Eye Reading Glasses</a></h4>
                                                        </div>
                                                        <!-- end of product title -->
                                                    ...
                                                    <!-- product info -->
                                                    <div class="product-info">
                                                        <div class="product-price"><h5>$17</h5></div>
                                                        <div class="product-rating">
                                                            <div class="star-rating">
                                                                <span></span>
                                                            </div>
                                        ...
                                        <div class="col-md-6 col-sm-12 col-lg-4 col-xl-3">
                                            ...
                                            <div class="single-product sold-product-tag">
                                                <div class="product-item">
                                                    ...
                                                    <!-- product info -->
                                                    <div class="product-info">
                                                        <div class="product-price"><h5>$19</h5></div>
                                                        <div class="product-rating">
                                                            <div class="star-rating">
                                                                <span></span>
                                                            </div>
                                        ...
                                        <div class="col-md-6 col-sm-12 col-lg-4 col-xl-3">
                                            ...
                                            <div class="single-product">
                                                <div class="product-item">
                                                    ...
                                                    <!-- product info -->
                                                    <div class="product-info">
                                                        <div class="product-price"><h5>$38</h5></div>
                                                        <div class="product-rating">
                                                            <div class="star-rating">
                                                                <span></span>
                                                            </div>
                                        ...
                                        <div class="col-md-6 col-sm-12 col-lg-4 col-xl-3">
                                            ...
                                            <div class="single-product">
                                                <div class="product-item">
                                                    ...
                                                    <!-- product info -->
                                                    <div class="product-info">
                                                        <div class="product-price"><h5>$08</h5></div>
                                                        <div class="product-rating">
                                                            <div class="star-rating">
                                                                <span></span>
                                                            </div>
                                ...
                                <div class="tab-pane fade" role="tabpanel" id="threecol" aria-labelledby="nav-three-col">
                                    <div class="row">
                                                ...
                                                <div class="product-item">
                                                    <div class="row align-items-center">
                                                        <div class="col-md-5">
                                                            ...
                                                            <div class="product-image">
                                                                <a href="shop-details.html">
                                                                    <img class='normal-state' data-rjs="2" src="assets/img/product/product-1v2.jpg" alt="">
                                                            ...
                                                            <div class="product-info">
                                                                ...
                                                                <!-- end of product title -->
                                                                    ...
                                                                    <a href="#" class="btn btn-fill-type">
                                                                        <span><img src="assets/img/icons/add-bag.svg" alt="" class="svg"></span>Add To Cart
                                                                    </a>
                                                                </div>
                                                            </div>
                                                                <!-- End of product info -->
                                                ...
                                                <div class="product-item">
                                                    <div class="row align-items-center">
                                                        <div class="col-md-5">
                                                            ...
                                                            <div class="product-image">
                                                                <a href="shop-details.html">
                                                                    <img class='normal-state' data-rjs="2" src="assets/img/product/product-2v2.jpg" alt="">
                                                                    <img class='hover-state' data-rjs="2" src="assets/img/product/product-2v2b.jpg" alt="">
                                                                    </a>
                                                            </div>
                                                            <!-- End of Product Image -->
                                                        ...
                                                        <div class="col-md-7">
                                                            ...
                                                            <div class="product-info">
                                                                ...
                                                                <!-- end of product title -->
                                                                    ...
                                                                    <div class="product-price"><h5>$20.1</h5></div>
                                                ...
                                                <div class="product-item">
                                                    <div class="row align-items-center">
                                                        <div class="col-md-5">
                                                            ...
                                                            <div class="product-image">
                                                                <a href="shop-details.html">
                                                                    <img class='normal-state' data-rjs="2" src="assets/img/product/product-3v2.jpg" alt="">
                                                                    <img class='hover-state' data-rjs="2" src="assets/img/product/product-3v2b.jpg" alt="">
                                                                    </a>
                                                            </div>
                                                            <!-- End of Product Image -->
                                                        ...
                                                        <div class="col-md-7">
                                                            ...
                                                            <div class="product-info">
                                                                ...
                                                                <!-- end of product title -->
                                                                    ...
                                                                    <div class="product-price"><h5>$39</h5></div>
                                                ...
                                                <div class="product-item">
                                                    <div class="row align-items-center">
                                                        <div class="col-md-5">
                                                            ...
                                                            <div class="product-image">
                                                                <a href="shop-details.html">
                                                                    <img class='normal-state' data-rjs="2" src="assets/img/product/product-5v2.jpg" alt="">
                                                                    <img class='hover-state' data-rjs="2" src="assets/img/product/product-5v2b.jpg" alt="">
                                                                    </a>
                                                            </div>
                                                            <!-- End of Product Image -->
                                                        ...
                                                        <div class="col-md-7">
                                                            ...
                                                            <div class="product-info">
                                                                ...
                                                                <!-- product title -->
                                                                <div class="product-title">
                                                                    <h4><a href="shop-details.html">Girls' Cat Eye Reading Glasses</a></h4>
                                                                </div>
                                                                <!-- end of product title -->
                                                ...
                                                <div class="product-item">
                                                    <div class="row align-items-center">
                                                        <div class="col-md-5">
                                                            ...
                                                            <div class="product-image">
                                                                <a href="shop-details.html">
                                                                    <img class='normal-state' data-rjs="2" src="assets/img/product/product-6v2.jpg" alt="">
                                                                    <img class='hover-state' data-rjs="2" src="assets/img/product/product-6v2b.jpg" alt="">
                                                                    </a>
                                                            </div>
                                                            <!-- End of Product Image -->
                                                        ...
                                                        <div class="col-md-7">
                                                            ...
                                                            <div class="product-info">
                                                                ...
                                                                <!-- end of product title -->
                                                                    ...
                                                                    <div class="product-price"><h5>$3.1</h5></div>
                                                ...
                                                <div class="product-item">
                                                    <div class="row align-items-center">
                                                        <div class="col-md-5">
                                                            ...
                                                            <div class="product-image">
                                                                <a href="shop-details.html">
                                                                    <img class='normal-state' data-rjs="2" src="assets/img/product/product-8v2.jpg" alt="">
                                                                    <img class='hover-state' data-rjs="2" src="assets/img/product/product-8v2b.jpg" alt="">
                                                                    </a>
                                                            </div>
                                                            <!-- End of Product Image -->
                                                        ...
                                                        <div class="col-md-7">
                                                            ...
                                                            <div class="product-info">
                                                                ...
                                                                <!-- product title -->
                                                                <div class="product-title">
                                                                    <h4><a href="shop-details.html">Tanglewood Outdoor Table Lamp</a></h4>
                                                                </div>
                                                                <!-- end of product title -->
                ...
                <div class="col-lg-3">
                    <aside>
                        ...
                        <div class="single-sidebar-widget mb-60">
                            <div class="search-form sidebar-search-form parsley-validate shop-sidebar">
                                ...
                                <ul class="list-unstyled mb-0">
                                    ...
                                    <li>
                                        <div class="new-product-wrap media">
                                            ...
                                            <div class="product-img-caption media-body">
                                                <h5><a href="#">Girls' Zipper Jumpsuit</a></h5>
                                                <h6>$32</h6>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        <div class="new-product-wrap media">
                                            ...
                                            <div class="product-img-caption media-body">
                                                <h5><a href="#">Pokemon Kid's Wrist Watch</a></h5>
                                                <h6>$42</h6>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        <div class="new-product-wrap media">
                                            ...
                                            <div class="product-img-caption media-body">
                                                <h5><a href="#">Stick Lamp Essentials</a></h5>
                                                <h6>$22</h6>
                                            </div>
                                        </div>
                                    </li>
                        ...
                        <!--Single sidebar widget -->
                        <div class="single-sidebar-widget mb-60">
                            <div class="sider-add-inner shope-add-sidebar" data-bg-img='assets/img/shop/shop-add.png'>
                        ...
                        <div class="single-sidebar-widget mb-60">
                            ...
                            <!--End of widget title -->
                            <div class="single-widget-color">
                                <ul class="color-list color-list mb-0 list-unstyled">
                                    <li><a href="#" class="color color1 active"></a></li>
                                    <li><a href="#" class="color color2"></a></li>
                                    <li><a href="#" class="color color3"></a></li>
                                    <li><a href="#" class="color color4"></a></li>
                    ...
                    <div class="col-md-6 col-lg-4 col-sm-6">
                        <div class="footer-widget">
                            <div class="footer-logo">
                                <a href="index.html"><img src="assets/img/ftr-logo.png" alt=""></a>
                            </div>
                            ...
                            <div class="footer-contact-wrap">
                                <ul class="footer-contact-list list-unstyled mb-0">
                                    ...
                                    <li>
                                        ...
                                        <a href="info%40emailname.html">Email: info@emailname.com</a>
                                    </li>
                                    <li>
                                        <span><i class="fa fa-phone" aria-hidden="true"></i></span>
                                        <a href="%2b006543219874.html">Phone: +00 654 321 9874</a>
                                    </li>
                                    <li>
...
<!-- Mirrored from www.themelooks.net/demo/kinen/html/preview/shop-4col-withbar.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 29 Aug 2024 15:45:45 GMT -->
</html>